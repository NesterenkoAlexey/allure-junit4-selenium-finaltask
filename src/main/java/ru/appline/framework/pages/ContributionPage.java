...
public class ContributionPage extends BasePage {
    ...
    public ContributionPage chooseCurrency(String currencyName) {
        switch (currencyName) {
            ...
            default: {
                Assert.fail("Нет такой валюты. Есть только RUB и USD");
                break;
            }
        }
        return this;
    ...
    public ContributionPage chooseDepositTerm(String depositTerm) {
        ...
        Assert.assertEquals("Проверка срока вклада", depositTerm, driverManager.getDriver().findElement(By.xpath("//div[@class = 'jq-selectbox__select-text']")).getText());
